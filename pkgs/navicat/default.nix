{ fetchurl, makeWrapper, appimageTools, lib, libGL, autoPatchelfHook
, wrapGAppsHook, glib, glibc, pango, harfbuzz, fontconfig, libX11, freetype
, e2fsprogs, expat, p11-kit, libxcb, libgpg-error, }:
let
  pname = "navicat";
  version = "17.0.4";
  src = fetchurl {
    url =
      "https://dn.navicat.com/download/navicat17-premium-cs-x86_64.AppImage";
...
in appimageTools.wrapType2 {
  ...
  meta = with lib; {
    ...
    description =
      "Navicat Premium is a multi-connection database development tool";
